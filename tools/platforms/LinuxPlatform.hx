...
class LinuxPlatform extends PlatformTarget
{
	...
	private function generateContext():Dynamic
	{
		...
		context.BUILD_DIR = project.app.path + "/linux" + (isArm ? "arm" : "") + (is64 ? "64" : "") + (isRaspberryPi ? "-rpi" : "");
	...
	public override function rebuild():Void
	{
		...
		else
		{
			...
			if (!targetFlags.exists("64") && !targetFlags.exists("x86_64") && System.hostArchitecture == X86 || System.hostArchitecture == X64)
			{
